...
<!-- INICIO DE LA TABLA -->
    <div class="row">
      <div class="col s6 offset-s6">
        <a href = "<?php echo "1_altaRecetasFormulario.html"; ?>" >
...
<?php 
  ...
  $sql = "SELECT idReceta,nombreReceta,tipoAlimento,tipoPlatillo,comida,ocasion FROM recetas ORDER BY tipoAlimento ASC";
