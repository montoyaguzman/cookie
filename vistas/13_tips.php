 		...
 		<div class="row">
 			<div class="col l10 offset-l1 m10 offset-m1 s10 offset-s1">
		       	<div class="card-panel brown darken-3">
		       		<span class="white-text center-align"><h5>Tips</h5></span>
				</div>
	    	</div>
	    </div>
	    	...
	    	<div class="col l10 offset-l1 m10 offset-m1 s10 offset-s1">
	    		<div class="z-depth-3 col l12">
					...
					<?php 
						...
						$sql = "SELECT nombre,link,descripcion FROM tipsCocina ORDER BY nombre ASC";
  						$consulta= mysqli_query($conexion,$sql);

  						while($datosTips = mysqli_fetch_array($consulta)) 
					    {	    			
						?>
						
						<div class="col l4 m6 s12">
							<div class="video-container">
        						<iframe width="560" height="315" src="<?php echo $datosTips['link']; ?>" frameborder="0" allowfullscreen></iframe>
      						</div>
      						<h6 class="center-align">
						        <strong>
      								<?php echo "".$datosTips['nombre'].""; ?>
      							</strong>
      						</h6>
      						<div class="col l12 m12 s12 progress red"></div>
						            <h6 class="center-align">
						            	<strong>
						            		<?php echo "".$datosTips['descripcion'].""; ?>
						            	</strong>
						            </h6>
      					</div>
      					<?php } ?>		
