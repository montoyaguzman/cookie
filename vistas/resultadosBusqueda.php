	    	...
	    	<div class="col l10 offset-l1 m10 offset-m1 s10 offset-s1">
	    		<div class="z-depth-3 col l12">
					...
					<?php 
						...
						$ingredienteBuscado = $_REQUEST['ingredienteBuscado'];

						//echo $ingredienteBuscado;

						//$sql = "SELECT * FROM recetas WHERE ingredientes LIKE "%".'$ingredienteBuscado'.% ORDER BY nombreReceta ASC";

//						$sql = "SELECT * FROM recetas WHERE ingredientes LIKE %".$ingredienteBuscado."% ORDER BY tipoAlimento ASC";

						$sql = "SELECT * FROM recetas WHERE nombreReceta LIKE '%$ingredienteBuscado%' ORDER BY nombreReceta ASC";
