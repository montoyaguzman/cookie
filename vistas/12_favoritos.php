 		...
 		<div class="row">
 			<div class="col l10 offset-l1 m10 offset-m1 s10 offset-s1">
		       	<div class="card-panel brown darken-3 l10 m10 s10">
		       		<span class="white-text center-align"><h5>Cookie Favoritos</h5></span>
				</div>
	    	</div>
	    </div>
	    	...
	    	<div class="col l10 offset-l1 m10 offset-m1 s10 offset-s1">
	    		...
	    		<div>
	    			<span class="blue-text text-darken-4">
	    				<h5><strong>¡Elije tu categoria de favoritos!</strong></h5>
	    			</span>
	    		</div>
    			...
    			<div class="row">
 					<div class="col l6 offset-l3 m8 offset-m2 s8 offset-s2">
		       			<div class="card-panel brown darken-3 l10 m10 s10">
		       				<span class="white-text center-align"><h5>Mis recetas favoritas</h5></span>
						</div>
			    	</div>
			    </div>
