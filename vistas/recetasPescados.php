 		...
 		<div class="row">
 			<div class="col l10 offset-l1 m10 offset-m1 s10 offset-s1">
		       	<div class="card-panel brown darken-3">
		       		<span class="white-text center-align"><h5>Pescados y mariscos</h5></span>
				</div>
	    	</div>
	    </div>
	    	...
	    	<div class="col l10 offset-l1 m10 offset-m1 s10 offset-s1">
	    		<div class="z-depth-3 col l12">
					...
					<?php 
						...
						$sql = "SELECT * FROM recetas WHERE tipoAlimento='Pescados y mariscos' ORDER BY nombreReceta ASC";
